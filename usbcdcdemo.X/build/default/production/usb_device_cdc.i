...
# 4 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\include\\c99\\limits.h" 2 3


# 1 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\include\\c99\\features.h" 1 3
# 6 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.10\\pic\\include\\c99\\limits.h" 2 3
...
# 346 "usb_device_cdc.c"
    cdc_trf_state = 0;
}
# 424 "usb_device_cdc.c"
_Bool USBCDCEventHandler(USB_EVENT event, void *pdata, uint16_t size)
{
...
# 556 "usb_device_cdc.c"
void putUSBUSART(uint8_t *data, uint8_t length)
{
# 581 "usb_device_cdc.c"
    {PIE2bits.USBIE = 0;};
    if(cdc_trf_state == 0)
    {
